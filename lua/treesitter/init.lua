-- Foldtext module shamelessly taken from <https://github.com/Wansmer/nvim-config/blob/main/lua/modules/foldtext.lua>
...
local EXCLUDE_END_LINE_FOR_FOLDS = {
  haskell = true,
}
...
function HighlightedFoldtext()
  ...
  local num_lines_folded = vim.v.foldend - vim.v.foldstart + 1
  local num_lines_displayed = EXCLUDE_END_LINE_FOR_FOLDS[vim.o.ft] and 1 or 2

  local folded = {
    { " ", "FoldedIcon" },
    (num_lines_folded > num_lines_displayed and {
      "+" .. num_lines_folded - num_lines_displayed .. " lines",
      "FoldedText",
    } or { "", "FoldedText" }),
    { " ", "FoldedIcon" },
  }
  ...
  if not EXCLUDE_END_LINE_FOR_FOLDS[vim.o.ft] then
...
_G.fold_text = HighlightedFoldtext
